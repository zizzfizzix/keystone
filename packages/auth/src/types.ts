import { BaseSchemaTypeTypeInfo, KeystoneContext } from '@keystone-6/core/types';
...
export type AuthConfig<ListTypeInfo extends BaseSchemaTypeTypeInfo> = {
...
export type InitFirstItemConfig<ListTypeInfo extends BaseSchemaTypeTypeInfo> = {
