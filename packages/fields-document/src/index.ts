...
export type DocumentFieldConfig<ListTypeInfo extends BaseSchemaTypeTypeInfo> =
...
function normaliseRelationships(
  configRelationships: DocumentFieldConfig<BaseSchemaTypeTypeInfo>['relationships'],
  meta: FieldData
) {
...
function normaliseDocumentFeatures(
  config: Pick<
    DocumentFieldConfig<BaseSchemaTypeTypeInfo>,
