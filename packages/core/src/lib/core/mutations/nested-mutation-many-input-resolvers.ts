...
type _CreateValueType = Exclude<
  graphql.InferValueFromArg<
    graphql.Arg<Exclude<GraphQLTypesForSchemaCcc['relateTo']['many']['create'], undefined>>
  >,
  null | undefined
>;
...
type _UpdateValueType = Exclude<
  graphql.InferValueFromArg<
    graphql.Arg<Exclude<GraphQLTypesForSchemaCcc['relateTo']['many']['update'], undefined>>
  >,
  null | undefined
>;
