...
export type FloatFieldConfig<SchemaCccTypeInfo extends BaseSchemaCccTypeInfo> =
...
export const float =
  <SchemaCccTypeInfo extends BaseSchemaCccTypeInfo>({
    ...
    defaultValue,
    ...config
  }: FloatFieldConfig<SchemaCccTypeInfo> = {}): FieldTypeFunc<SchemaCccTypeInfo> =>
  meta => {
    if (
      ...
      throw new Error(
        `The float field at ${meta.schemaCccKey}.${meta.fieldKey} specifies a default value of: ${defaultValue} but it must be a valid finite number`
      );
    }
    ...
    if (
      ...
      throw new Error(
        `The float field at ${meta.schemaCccKey}.${meta.fieldKey} specifies validation.min: ${validation.min} but it must be a valid finite number`
      );
    }
    ...
    if (
      ...
      throw new Error(
        `The float field at ${meta.schemaCccKey}.${meta.fieldKey} specifies validation.max: ${validation.max} but it must be a valid finite number`
      );
    }
    ...
    if (
      ...
      throw new Error(
        `The float field at ${meta.schemaCccKey}.${meta.fieldKey} specifies a validation.max that is less than the validation.min, and therefore has no valid options`
      );
    }
