...
export type KeystoneListsAPI<KeystoneListsTypeInfo extends Record<string, BaseSchemaTypeTypeInfo>> =
  {
...
export type KeystoneDbAPI<KeystoneListsTypeInfo extends Record<string, BaseSchemaTypeTypeInfo>> = {
  [Key in keyof KeystoneListsTypeInfo]: {
    findMany(args?: {
      readonly where?: KeystoneListsTypeInfo[Key]['inputs']['where'];
      readonly take?: number;
