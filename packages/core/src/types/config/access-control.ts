...
type BaseAccessArgs<ListTypeInfo extends BaseSchemaTypeTypeInfo> = {
  session: any;
  listKey: string;
...
type FilterOutput<ListTypeInfo extends BaseSchemaTypeTypeInfo> =
  | boolean
...
type CreateItemAccessArgs<ListTypeInfo extends BaseSchemaTypeTypeInfo> =
...
export type CreateListItemAccessControl<ListTypeInfo extends BaseSchemaTypeTypeInfo> = (
  args: CreateItemAccessArgs<ListTypeInfo>
) => MaybePromise<boolean>;

type UpdateItemAccessArgs<ListTypeInfo extends BaseSchemaTypeTypeInfo> =
  BaseAccessArgs<ListTypeInfo> & {
    operation: 'update';
    /**
...
export type UpdateListItemAccessControl<ListTypeInfo extends BaseSchemaTypeTypeInfo> = (
  args: UpdateItemAccessArgs<ListTypeInfo>
) => MaybePromise<boolean>;

type DeleteItemAccessArgs<ListTypeInfo extends BaseSchemaTypeTypeInfo> =
  BaseAccessArgs<ListTypeInfo> & {
    operation: 'delete';
    /**
...
export type DeleteListItemAccessControl<ListTypeInfo extends BaseSchemaTypeTypeInfo> = (
...
//
export type ListAccessControl<ListTypeInfo extends BaseSchemaTypeTypeInfo> = {
...
export type FieldCreateItemAccessArgs<ListTypeInfo extends BaseSchemaTypeTypeInfo> =
  CreateItemAccessArgs<ListTypeInfo> & { fieldKey: string };

export type FieldReadItemAccessArgs<ListTypeInfo extends BaseSchemaTypeTypeInfo> =
  BaseAccessArgs<ListTypeInfo> & {
    operation: 'read';
    fieldKey: string;
    item: ListTypeInfo['item'];
...
export type FieldUpdateItemAccessArgs<ListTypeInfo extends BaseSchemaTypeTypeInfo> =
  UpdateItemAccessArgs<ListTypeInfo> & { fieldKey: string };

export type FieldAccessControl<ListTypeInfo extends BaseSchemaTypeTypeInfo> =
  | {
