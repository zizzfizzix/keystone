...
import { FieldTypeFunc, BaseSchemaCccTypeInfo } from '@keystone-6/core/types';
import { apiTestConfig } from '../../utils';

const listKey = 'Test';
const filterTestRunner = (field: FieldTypeFunc<BaseSchemaCccTypeInfo>) =>
  setupTestRunner({
...
export function filterTests(
  field: FieldTypeFunc<BaseSchemaCccTypeInfo>,
  cb: (match: Match) => void
) {
