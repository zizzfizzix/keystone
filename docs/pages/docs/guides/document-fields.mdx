...
<summary>
  In the [document editor demo](/docs/guides/document-field-demo), the insertable Quote, Notice and
...
{/* NOTE: Waiting for https://github.com/prettier/prettier/pull/11563 to be merged to fix this prettier issue */}
{/* TBC: ### Child Fields */}
...
<RelatedContent>
  ...
  >
    Illustrates how to configure <InlineCode>document</InlineCode> fields in your Keystone system
    and render their data in a frontend application. Builds on the Blog starter project.
  </Well>
  <Well heading="Document Field Demo" href="/docs/guides/document-field-demo">
    Test drive the many features of Keystone’s Document field on this website.
  </Well>
</RelatedContent>

export default ({ children }) => (
  <Markdown description="Learn how to configure Keystone’s highly customizable Rich Text editor. The Document field is built with Slate and stores your content as JSON-structured data.">
    {children}
  </Markdown>
);
